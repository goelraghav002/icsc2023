        ...
        <div class="flex flex-col text-center md:text-left space-y-2">
            <div class="flex flex-col space-y-1">
                <h2 class="text-black font-bold text-xs lg:text-xl">
                    2023 9<sup>TH</sup> INTERNATIONAL CONFERENCE ON SIGNAL PROCESSING AND COMMUNICATION (ICSC)
                </h2>
            ...
            <div class="flex md:flex-row flex-col space-x-2 items-center">
                <p class="text-blue-700 text-xs font-bold lg:text-lg">21-23 Dec 2023</p>
            ...
            <span class="text-blue-900 text-xs lg:text-xl font-bold">IEEE Conference Record Number - 60394 (Approved)</span>
        </div>
    ...
    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-blue-600 rounded-none w-52">
        ...
        <li tabindex="0">
            ...
            <ul class="bg-blue-600 p-2">
                ...
                <li><a href="https://edas.info/login.php?rurl=aHR0cHM6Ly9lZGFzLmluZm8vTjMxMjQ2P2M9MzEyNDY=">Paper Submission</a></li>
...
<ul class="hidden bg-blue-600 text-white lg:flex menu menu-horizontal rounded-none p-0 z-2 text-center justify-center">
    ...
    <li class="border-l border-white text-xs font-bold uppercase" tabindex="0">
        ...
        <ul class="bg-blue-600 p-0 rounded-none">
            ...
            <li class="text-xs font-bold uppercase"><a href="https://edas.info/login.php?rurl=aHR0cHM6Ly9lZGFzLmluZm8vTjMxMjQ2P2M9MzEyNDY=">Paper Submission</a></li>
